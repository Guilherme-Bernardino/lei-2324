...
public class RouteDurationDijkstraStrategy implements DijkstraStrategy {
    ...
    @Override
    public void findMaxPathThroughDijkstra(Graph<Stop, Route> graph, Vertex<Stop> start, Map<Vertex<Stop>, Integer> durations, Map<Vertex<Stop>, Vertex<Stop>> predecessors, Map<Vertex<Stop>, Edge<Route, Stop>> edgePredecessors) {

    }

    @Override
    public Vertex<Stop> findMaxCostVertex(Map<Vertex<Stop>, Integer> durations, List<Vertex<Stop>> unvisited) {
        return null;
    }
