...
/**
 * ReadDemoStrategy (Strategy pattern), implements the ReaderStrategy, is responsible for reading the dataset and images
 * of the Demo file.
 *
 * @author Guilherme B. 202001870
 */
public class ReadDemoStrategy implements ReaderStrategy {

    private static final Path THIS_PATH = Path.DEMO;
    private Gson gson;
    private DataList dataList;
    private List<Image> images;
    private List<String> thisPath;

    public ReadDemoStrategy(){
        this.gson = new Gson();
