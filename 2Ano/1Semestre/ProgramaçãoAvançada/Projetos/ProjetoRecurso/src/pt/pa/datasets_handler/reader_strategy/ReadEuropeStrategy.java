...
/**
 * ReadEuropeStrategy (Strategy pattern), implements the ReaderStrategy, is responsible for reading the dataset and images
 * of the Europe file.
 *
 * @author Guilherme B. 202001870
 */
public class ReadEuropeStrategy implements ReaderStrategy{
    private static final Path THIS_PATH = Path.EUROPE;
    private Gson gson;
    private DataList dataList;
    private List<Image> images;
    private List<String> thisPath;

    public ReadEuropeStrategy(){
        this.gson = new Gson();
