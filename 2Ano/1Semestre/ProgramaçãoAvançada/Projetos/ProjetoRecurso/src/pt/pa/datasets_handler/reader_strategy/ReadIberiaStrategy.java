...
/**
 * ReadIberiaStrategy (Strategy pattern), implements the ReaderStrategy, is responsible for reading the dataset and images
 * of the Iberia file.
 *
 * @author Guilherme B. 202001870
 */
public class ReadIberiaStrategy implements ReaderStrategy{
    private static final Path THIS_PATH = Path.IBERIA;
    private Gson gson;
    private DataList dataList;
    private List<Image> images;
    private List<String> thisPath;

    public ReadIberiaStrategy(){
        this.gson = new Gson();
